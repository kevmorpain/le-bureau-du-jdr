...
- Ce que le cloud ne couvre **pas** : les bindings réels (D1/KV/R2 de prod), donc pas de
  migration appliquée ni de seed — seulement leur bundling dans `.output/server/db/migrations/`.
